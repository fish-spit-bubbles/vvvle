            ...
            <!-- <form action="#" method="##" name="##" onsubmit=""> -->
                <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
                    <tr>
                        ...
                        <td width="80%">
                        <input ng-model="username" name="username" type="text" size="25" id="username"  class="bg"/>
                    ...
                    <tr>
                        ...
                        <td>
                        <input ng-model="email" name="email" type="text" size="25" id="email"  class="bg"/>
                    ...
                    <tr>
                        ...
                        <td>
                        <input ng-model="pwd"  name="password" type="password" id="password1"  class="bg"/>
                    ...
                    <tr>
                        ...
                        <td>
                        <input ng-model="repwd" name="confirm_password" type="password" id="conform_password" class="bg"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input ng-model="qq" name="extend_field2" type="text" size="25" class="bg" />          
                         </td>
                    </tr>
                    <tr>
                        <td align="right" id="WeChat" >微信</td>  
                        <td>
                            <input ng-model="wechat" name="extend_field102" type="text" size="25" class="bg" id="WeChat" />         
                        </td>
                    </tr>        
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td align="left">
                            <input ng-click="sub()" name="Submit"  class="liji">
                        </td>
                    </tr>
                </table>
            <!-- </form> -->
