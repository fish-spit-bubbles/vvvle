        ...
        <div class="containerre" title="select_box">
            <div class="machine" title="vary">
                ...
                <div class="machine_Kindd" monde="kind">
                    ...
                    <a class="nolimit_choice" href="#">叠加眼镜盒</a>
                    <a class="nolimit_choice" href="#">花王</a>
                    <a class="nolimit_choice" href="#">3N</a>
                    <a class="nolimit_choice" href="#">ATEX</a>
                </div>
            ...
            <div class="machine">
                ...
                <div class="machine_Kindd">
                    <a class="nolimit" href="#">不限</a>
                    <a class="nolimit_choice" href="#">配件</a>
                </div>
            ...
            <div class="machine">
                ...
                <div class="machine_Kindd">
                    ...
                    <a class="nolimit_choice" href="#">眼镜养护</a>
                </div>
