                    ...
                    <li ng-cloak ng-repeat="v in goodsLists">
                        ...
                        <a href="__APP__/ProductDetails/index?id={{v.id}}" class="classis_a">
                            ...
                            <div class="classis_info clearfix">
                                <img width="283" height="283" ng-src="__ROOT__/{{v.productImg}}" alt="">
...
<script>
    ...
    app.controller("mycontroller", function ($scope, $http) {
        ...
        $(".show_nav li").on("click",function(){
            var qing=$(this).find(".searchB").html();
            $.ajax({
                url:"__APP__/ProductDetails/getDetailGoods",
                data:{qing:qing},
                dataType:"json",
                type: "post",
                success:function(data){
                    if (data.status == 1) {
                        window.location.href = "__APP__/ProductDetails/index?id=" + data.data["id"];
                    } else {
                        alert("没有此商品");
                    }
                }
